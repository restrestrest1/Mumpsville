...
gdjs.evtsExt__RollingCounter__RollingCounter = gdjs.evtsExt__RollingCounter__RollingCounter || {};

/**
 * Behavior generated from Rolling counter
 */
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter = class RollingCounter extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData = {};
    this._sharedData = gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.getSharedData(
      instanceContainer,
      behaviorData.name
    );
  ...
  updateFromBehaviorData(oldBehaviorData, newBehaviorData) {
    ...
    if (oldBehaviorData.Suffix !== newBehaviorData.Suffix)
      this._behaviorData.Suffix = newBehaviorData.Suffix;
    if (oldBehaviorData.Duration !== newBehaviorData.Duration)
      this._behaviorData.Duration = newBehaviorData.Duration;
    if (oldBehaviorData.Increment !== newBehaviorData.Increment)
      this._behaviorData.Increment = newBehaviorData.Increment;
    if (oldBehaviorData.CounterValue !== newBehaviorData.CounterValue)
      this._behaviorData.CounterValue = newBehaviorData.CounterValue;
    if (oldBehaviorData.DisplayedValue !== newBehaviorData.DisplayedValue)
      this._behaviorData.DisplayedValue = newBehaviorData.DisplayedValue;
 ...
 */
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.SharedData = class RollingCounterSharedData {
...
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.getSharedData = function(instanceContainer, behaviorName) {
  if (!instanceContainer._RollingCounter_RollingCounterSharedData) {
    const initialData = instanceContainer.getInitialSharedDataForBehavior(
      behaviorName
    );
    instanceContainer._RollingCounter_RollingCounterSharedData = new gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.SharedData(
      initialData
    );
  }
  return instanceContainer._RollingCounter_RollingCounterSharedData;
}

// Methods:
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.doStepPreEventsContext = {};
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.doStepPreEventsContext.GDObjectObjects1= [];
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.doStepPreEventsContext.GDObjectObjects2= [];


gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.doStepPreEventsContext.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.doStepPreEvents = function(parentEventsFunctionContext) {
...
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.SetValueContext = {};
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.SetValueContext.GDObjectObjects1= [];
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.SetValueContext.GDObjectObjects2= [];


gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.SetValueContext.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__RollingCounter__RollingCounter.RollingCounter.prototype.SetValue = function(Value, parentEventsFunctionContext) {
